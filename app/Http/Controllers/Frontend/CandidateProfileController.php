...
class CandidateProfileController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render("Frontend/CandidateProfiles/Index", [
            "locations" => $locations,
    ...
    public function show(Candidate $candidate)
    {
        ...
        return Inertia::render("Frontend/CandidateProfiles/Show", [
            "candidate" => $candidate,
    ...
    public function location_show(Location $location, array $breadcrumbs = [])
    {
        ...
        return Inertia::render("Frontend/CandidateProfiles/LocationShow", [
            "location" => $location,
